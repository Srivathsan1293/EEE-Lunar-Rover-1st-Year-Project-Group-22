#!/usr/bin/env python3
"""
Generic Joystick → Rover Motor Control
Left stick Y = forward/back, Left stick X = steering.

Dependencies:
    pip install pygame

First run:
    python rover_control.py --map    # identify your stick axes
Normal run:
...
def run(js, mapping):
    ...
    try:
        while True:
            ...
            # ── Replace with your MQTT publish / serial write ─────────────────
            print(
